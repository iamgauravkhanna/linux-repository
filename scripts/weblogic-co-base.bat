...
echo #####################################################################
echo #                                                                   
echo #             Weblogic  : C:\hcentive-code\server\COHIX_Base
echo #                                                                   
echo #                                                                   
echo #####################################################################

:: Variables Definition
del "C:\logs\COHIX_Base.log" /Q
SET LOG_LOCATION=C:\logs\COHIX_Base.log
SET CODE_BASE=C:\hcentive-code\server\COHIX_Base

...
echo #####################################################################
echo #                                                                   #
echo #             Auto Tomcat Code Compilation Script                   #
echo #                                                                   #
echo #                                                                   #
echo #####################################################################

:: Variables Definition
del "C:\logs\tomcat.log" /Q
SET LOG_LOCATION=C:\logs\tomcat.log
...
call mvn clean install -f pom.xml -P prod >> "%LOG_LOCATION%" 2>&1

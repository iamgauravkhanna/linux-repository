...
echo #####################################################################
echo #                                                                   
echo #             Local Tomcat : COHIX_PRD_1.2
echo #                                                                   
echo #                                                                   
echo #####################################################################

:: Variables Definition
del "C:\logs\COHIX_PRD_1.2-Local.log" /Q
SET LOG_LOCATION=C:\logs\COHIX_PRD_1.2-Local.log
SET CODE_BASE=C:\hcentive-code\COHIX_PRD_1.2

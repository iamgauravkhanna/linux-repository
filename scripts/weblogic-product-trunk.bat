...
echo #####################################################################
echo #                                                                   
echo #             Weblogic Code Compilation : C:\hcentive-code\server\private-exchange      
echo #                                                                   
echo #                                                                   
echo #####################################################################

:: Variables Definition
del "C:\logs\server-product-trunk.log" /Q
SET LOG_LOCATION=C:\logs\server-product-trunk.log
SET CODE_BASE=C:\hcentive-code\server\private-exchange
